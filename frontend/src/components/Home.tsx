...
const Home: React.FC<HomeProps> = ({ onGetStarted }) => {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto">
            <motion.div
            ...
            <motion.h1
                ...
                className="text-4xl md:text-6xl font-black leading-tight bg-gradient-to-r from-slate-900 via-primary to-slate-700 dark:from-white dark:via-sky-400 dark:to-slate-400 bg-clip-text text-transparent mb-6 tracking-tight"
            >
            ...
            <motion.p
                ...
                className="text-lg text-slate-500 dark:text-slate-400 leading-relaxed max-w-2xl mb-10"
            >
            ...
            >
                <button
                    ...
                    className="group relative px-8 py-3.5 bg-primary text-white font-bold rounded-xl shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0 transition-all text-base flex items-center gap-2 cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                {[
                    ...
                    <motion.div
                        ...
                        className="glass-card flex flex-col items-center p-6 bg-white/40 dark:bg-slate-800/40 hover:bg-white/60 dark:hover:bg-slate-800/60 transition-colors text-center group"
                    >
                        <div className={`p-3 ${feat.color} rounded-xl mb-4 group-hover:scale-110 transition-transform`}>
                            {feat.icon}
                        </div>
                        <h3 className="text-base font-bold mb-2 text-slate-800 dark:text-slate-100">{feat.title}</h3>
